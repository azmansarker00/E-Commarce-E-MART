              ...
              <div className="  px-4 md:px-0 mb-16">
                ...
                <div className=" flex justify-end">
                  <button
                    onClick={add}
                    type="button"
                    className="focus:outline-none text-white cursor bg-orange-400 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-orange-500 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
                    style={{
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-10">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  {user.map((item, index) => {
                    const { name, uid, email, time, id } = item;
                    return (
                      <tbody>
                        <tr
                          className="bg-gray-50 border-b  dark:border-gray-700"
